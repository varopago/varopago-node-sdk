...
Varopago.BASE_URL = 'https://api.varopago.com';
Varopago.API_VERSION = '/v1/';
Varopago.SANDBOX_URL = 'https://sandbox-api.varopago.com';
Varopago.SANDBOX_API_VERSION = '/v1/';


function Varopago(merchantId, privateKey, isProductionReady) {
...
Varopago.prototype.define = function(baseData) {
...
var sendRequest = function (data) {
  var baseUrl = data.isSandbox ? Varopago.SANDBOX_URL + Varopago.SANDBOX_API_VERSION : Varopago.BASE_URL + Varopago.API_VERSION;
